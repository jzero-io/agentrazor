...
var RoutesCodesMap = map[string]string{
	...
	"POST:/api/v1/conversations":                                               "v1:conversation:sendMessage",
	...
	"GET:/api/v1/conversations/:conversation_id/metadata":                      "v1:conversation:metadata",
	"POST:/api/v1/conversations/:conversation_id/turn/cancel":                  "v1:conversation:cancelTurn",
	"GET:/api/v1/conversations/:conversation_id/workspace/files":               "v1:conversation:workspaceFiles",
	"GET:/api/v1/conversations/stats":                                          "v1:conversation:stats",
