...
var RoutesCodesMap = map[string]string{
	...
	"GET:/api/v1/home/overview":                                                      "v1:manage:agent:homeOverview",
	...
	"GET:/api/v1/manage/agent/characters":                                            "v1:manage:character:list",
	"POST:/api/v1/manage/agent/characters/builtin":                                   "v1:manage:character:create",
	"DELETE:/api/v1/manage/agent/characters/builtin/:character_id":                   "v1:manage:character:delete",
	"PATCH:/api/v1/manage/agent/characters/builtin/:character_id":                    "v1:manage:character:update",
