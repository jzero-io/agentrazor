...
var RoutesCodesMap = map[string]string{
	...
	"GET:/api/v1/conversation/:conversation_id/workspace/file":                 "v1:conversation:workspaceFile",
	...
	"GET:/api/v1/conversation/token-quota":                                     "v1:conversation:tokenQuotaStatus",
	...
	"POST:/api/v1/manage/agent/auth/provider-api-key":                          "v1:manage:agent:saveProviderApiKey",
	...
	"POST:/api/v1/manage/agent/settings/selection":                             "v1:manage:agent:saveSelection",
