...
type UsageConversations struct {
	logx.Logger
	ctx    context.Context
...
func NewUsageConversations(ctx context.Context, svcCtx *svc.ServiceContext, r *http.Request) *UsageConversations {
	return &UsageConversations{
...
func (l *UsageConversations) UsageConversations(req *types.TokenUsageConversationsRequest) (resp *types.TokenUsageConversationsResponse, err error) {
	...
	current, size := normalizeUsagePage(req.Current, req.Size)
