...
// 获取 Token 消耗趋势
func NewUsageTrend(ctx context.Context, svcCtx *svc.ServiceContext, r *http.Request) *UsageTrend {
	return &UsageTrend{
...
func (l *UsageTrend) UsageTrend(req *types.TokenUsageTrendRequest) (resp *types.TokenUsageTrendResponse, err error) {
