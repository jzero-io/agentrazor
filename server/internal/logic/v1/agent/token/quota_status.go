...
// 获取当前用户 Token 额度状态
func NewQuotaStatus(ctx context.Context, svcCtx *svc.ServiceContext, r *http.Request) *QuotaStatus {
	return &QuotaStatus{
...
func (l *QuotaStatus) QuotaStatus() (resp *types.TokenQuotaStatusResponse, err error) {
