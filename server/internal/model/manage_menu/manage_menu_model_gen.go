...
type (
	manageMenuModel interface {
		...
		FindFieldsByCondition(ctx context.Context, session sqlx.Session, fields []condition.Field, conditions ...condition.Condition) ([]*ManageMenu, error)
		FindOneByCondition(ctx context.Context, session sqlx.Session, conditions ...condition.Condition) (*ManageMenu, error)
		FindOneFieldsByCondition(ctx context.Context, session sqlx.Session, fields []condition.Field, conditions ...condition.Condition) (*ManageMenu, error)
...
func (m *defaultManageMenuModel) withTableFields(fields ...string) []string {
...
func (m *customManageMenuModel) FindFieldsByCondition(ctx context.Context, session sqlx.Session, fields []condition.Field, conditions ...condition.Condition) ([]*ManageMenu, error) {
	if len(fields) == 0 {
		fields = condition.ToFieldSlice(manageMenuFieldNames)
	}
...
func (m *customManageMenuModel) FindOneByCondition(ctx context.Context, session sqlx.Session, conditions ...condition.Condition) (*ManageMenu, error) {
	return m.FindOneFieldsByCondition(ctx, session, condition.ToFieldSlice(manageMenuFieldNames), conditions...)
}

func (m *customManageMenuModel) FindOneFieldsByCondition(ctx context.Context, session sqlx.Session, fields []condition.Field, conditions ...condition.Condition) (*ManageMenu, error) {
	statement, args := condition.BuildSelectWithFlavor(m.flavor, sqlbuilder.Select(m.withTableFields(cast.ToStringSlice(manageMenuFieldNames)...)...).From(m.table).Limit(1), conditions...)
...
func (m *customManageMenuModel) PageByCondition(ctx context.Context, session sqlx.Session, conditions ...condition.Condition) ([]*ManageMenu, int64, error) {
	statement, args := condition.BuildSelectWithFlavor(m.flavor, sqlbuilder.Select(m.withTableFields(manageMenuFieldNames...)...).From(m.table), conditions...)
