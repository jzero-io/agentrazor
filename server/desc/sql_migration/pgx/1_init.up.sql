...
VALUES
    ...
    ('d7e8f9a0-b1c2-4334-87d8-e9f0a1b2c3d4','2024-11-11 10:29:33','2024-11-11 10:29:33','1','a1b2c3d4-e5f6-4782-91a0-b9c8d7e6f5a4','2','菜单管理',0,'',5,'manage_menu','/manage/menu','view.manage_menu','material-symbols:route','1','route.manage_menu',0,'',0,0,'[]','[{"code":"v1:manage:menu:list","desc":"菜单列表"},{"code":"v1:manage:menu:getAllPages","desc":"获取菜单页面"}]',0,''),
