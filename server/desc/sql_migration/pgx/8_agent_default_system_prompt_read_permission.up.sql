INSERT INTO "manage_menu" (
    ...
    'e110f1d2-8d73-4ff9-9702-4f7395b7a007', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    '1', 'aa10f1d2-8d73-4ff9-9702-4f7395b7a003', '3', '读取默认系统提示词',
    0, '', 5, '', '', '', '', '1', 'button.agent.config.readDefaultSystemPrompt',
    0, '', 0, 0, '[]',
    '[{"code":"v1:manage:agent:getDefaultSystemPrompt","desc":"读取默认系统提示词"}]',
    0, 'v1:manage:agent:getDefaultSystemPrompt'
)
ON CONFLICT (uuid) DO NOTHING;

UPDATE "manage_menu"
SET "order" = 6,
    permissions = '[{"code":"v1:manage:agent:getDefaultSystemPrompt","desc":"读取默认系统提示词"},{"code":"v1:manage:agent:saveDefaultSystemPrompt","desc":"保存默认系统提示词"}]',
...
VALUES (
    md5('1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d:e110f1d2-8d73-4ff9-9702-4f7395b7a007'),
    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    '1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d',
    'e110f1d2-8d73-4ff9-9702-4f7395b7a007', 0
)
ON CONFLICT (uuid) DO NOTHING;
