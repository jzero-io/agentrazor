INSERT INTO "manage_menu" (
    ...
    '1', 'aa10f1d2-8d73-4ff9-9702-4f7395b7a003', '3', '保存默认系统提示词',
    0, '', 5, '', '', '', '', '1', 'button.agent.config.saveDefaultSystemPrompt',
    0, '', 0, 0, '[]',
    '[{"code":"v1:manage:agent:saveDefaultSystemPrompt","desc":"保存默认系统提示词"}]',
    0, 'v1:manage:agent:saveDefaultSystemPrompt'
)
ON CONFLICT (uuid) DO NOTHING;

INSERT INTO "manage_role_menu" (uuid, create_time, update_time, role_uuid, menu_uuid, is_home)
VALUES (
    md5('1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d:e110f1d2-8d73-4ff9-9702-4f7395b7a006'),
    CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
    '1a2b3c4d-5e6f-7a8b-9c0d-1e2f3a4b5c6d',
    'e110f1d2-8d73-4ff9-9702-4f7395b7a006', 0
)
ON CONFLICT (uuid) DO NOTHING;
