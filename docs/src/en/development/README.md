...
Main state lives in `agent/src/App.vue`; process display mapping lives in `agent/src/utils/processDisplay.ts`. When changing streaming behavior, verify refresh, conversation switching, and SSE reconnect paths.
